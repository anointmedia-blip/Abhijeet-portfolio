...
const TechStack = () => {
  ...
  useEffect(() => {
    // Refresh ScrollTrigger when TechStack mounts to update pinning spacers and offsets
    ...
    const handleScroll = () => {
      ...
      if (techstackEl) {
        ...
        // Activate physics when the TechStack section starts entering the viewport
